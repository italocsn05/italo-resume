...
\begin{minipage}[t]{\linewidth}
    \begin{itemize}[nosep,after=\strut, leftmargin=2em, itemsep=2pt]
        \item Planejei e implementei toda a automa\c{c}\~ao de testes do zero, atuando efetivamente como Tech Lead (a responsabilidade, ainda que n\~ao o t\'itulo oficial), e integrei-a aos pipelines de CI/CD com quality gates para garantir a qualidade cont\'inua do software.
